...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.card, .col-md-4, .col-md-6, section').forEach(el => {
        observer.observe(el);
    });
  ...
  forms.forEach(form => {
    ...
    document.querySelectorAll('button, a').forEach(element => {
        if (!element.getAttribute('aria-label') && !element.textContent.trim()) {
            element.setAttribute('aria-label', element.getAttribute('title') || 'Bouton');
        }
    });
    ...
    console.log('Dour Maroc - Scripts chargés avec succès!');
});
